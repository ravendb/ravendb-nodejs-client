...
import { AddCdcSinkOperationResult } from "./AddCdcSinkOperationResult.js";
...
export class AddCdcSinkOperation implements IMaintenanceOperation<AddCdcSinkOperationResult> {
    ...
    constructor(configuration: CdcSinkConfiguration) {
    ...
    getCommand(conventions: DocumentConventions): RavenCommand<AddCdcSinkOperationResult> {
        return new AddCdcSinkCommand(conventions, this._configuration);
    }
}
...
class AddCdcSinkCommand extends RavenCommand<AddCdcSinkOperationResult> implements IRaftCommand {
    ...
    constructor(conventions: DocumentConventions, configuration: CdcSinkConfiguration) {
        super();
