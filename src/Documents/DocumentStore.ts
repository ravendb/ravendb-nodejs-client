...
export class DocumentStore implements IDocumentStore {
  ...
  public async generateId(document: object, documentType?: DocumentType, database?: string, callback?: EntityKeyCallback): Promise<string> {
    ...
    return this.generator.generateDocumentKey(document, documentType, database)
      .then((string: string) => {
